...
void visualizeCroppedResults(PointCloudPtr inputCloudPtr, PointCloudPtr croppedReferenceCloudPtr,
    ...
    pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ> tf_cloud_color_handler1(
        inputCloudPtr, 255, 0, 0);
    viewer.addPointCloud<pcl::PointXYZ>(inputCloudPtr, tf_cloud_color_handler1,
                                        "initial aligned cloud1");
    pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ> tf_cloud_color_handler2(
        croppedReferenceCloudPtr, 0, 255, 0);
    viewer.addPointCloud<pcl::PointXYZ>(croppedReferenceCloudPtr, tf_cloud_color_handler2,
                                        "initial aligned cloud2");
    pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ> tf_cloud_color_handler3(
        croppedSourceCloudPtr, 0, 0, 255);
    viewer.addPointCloud<pcl::PointXYZ>(croppedSourceCloudPtr, tf_cloud_color_handler3,
                                        "initial aligned cloud3");
...
void visualizePtClouds(PointCloudPtr inputSrcCloudPtr, PointCloudPtr inputTrgCloudPtr) {
    ...
    pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ> tf_cloud_color_handler1(
        inputSrcCloudPtr, 255, 0, 0);
    viewer.addPointCloud<pcl::PointXYZ>(inputSrcCloudPtr, tf_cloud_color_handler1,
                                        "initial aligned cloud1");
    pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ> tf_cloud_color_handler2(
        inputTrgCloudPtr, 0, 255, 0);
    viewer.addPointCloud<pcl::PointXYZ>(inputTrgCloudPtr, tf_cloud_color_handler2,
                                        "initial aligned cloud2");
...
void visualizeSinglePointCloudForHarris(PointCloudPtr inputCloudPtr,
    ...
    // Visualization of keypoints along with the original cloud
    pcl::visualization::PCLVisualizer viewer("PCL Viewer");
    pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZI> keypoints_color_handler(
        inputKeypointsCloudPtr, 0, 255, 0);
    pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ> cloud_color_handler(
        inputCloudPtr, 255, 255, 0);
...
void visualizeMultipleResultsPointCloudHarris(PointCloudPtr sourceCloudPtr,
    ...
    pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ> src_cloud_color_handler(
        sourceCloudPtr, 255, 255, 0);
    pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ> tar_cloud_color_handler(
        targetCloudPtr, 0, 255, 255);
    // visualizer 1
    ...
    pcl::visualization::PointCloudColorHandlerCustom<PointWithIntensity>
        src_keypoints_color_handler(srcKeypointsCloudPtr, 255, 0, 0);
    viewer.addPointCloud<PointWithIntensity>(srcKeypointsCloudPtr, src_keypoints_color_handler,
                                             "source keypoints", v1);
    viewer.setPointCloudRenderingProperties(pcl::visualization::PCL_VISUALIZER_POINT_SIZE, 7,
                                            "source keypoints");
    pcl::visualization::PointCloudColorHandlerCustom<PointWithIntensity>
        tar_keypoints_color_handler(trgKeypointsCloudPtr, 0, 0, 255);
    viewer.addPointCloud<PointWithIntensity>(trgKeypointsCloudPtr, tar_keypoints_color_handler,
                                             "target keypoints", v1);
    viewer.setPointCloudRenderingProperties(pcl::visualization::PCL_VISUALIZER_POINT_SIZE, 7,
                                            "target keypoints");
    // Add transformed point cloud to viewer
    pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ> tf_cloud_color_handler(
        transformedCloudPtr, 0, 255, 0);
    viewer.addPointCloud<pcl::PointXYZ>(transformedCloudPtr, tf_cloud_color_handler,
                                        "initial aligned cloudv2", v2);
    pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ> target_cloud_color_handler(
        targetCloudPtr, 0, 0, 255);
    viewer.addPointCloud<pcl::PointXYZ>(targetCloudPtr, target_cloud_color_handler,
                                        "aligned cloudv2", v2);
...
void visualizeMultipleResultsPointCloudSift(PointCloudPtr inputSrcCloudPtr,
    ...
    pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ> src_cloud_color_handler(
        inputSrcCloudPtr, 255, 255, 0);
    pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ> tar_cloud_color_handler(
        inputTrgCloudPtr, 0, 255, 255);
    // visualizer 1
    ...
    viewer.addPointCloud(transformedCloudPtr, tar_cloud_color_handler, "transformed cloud v2", v2);
    // Show keypoints in 3D viewer
    pcl::visualization::PointCloudColorHandlerCustom<PointWithScale> src_keypoints_color_handler(
        sourceSiftKeypointsPtr, 255, 0, 0);
    viewer.addPointCloud<PointWithScale>(sourceSiftKeypointsPtr, src_keypoints_color_handler,
                                         "source keypoints", v1);
    viewer.setPointCloudRenderingProperties(pcl::visualization::PCL_VISUALIZER_POINT_SIZE, 7,
                                            "source keypoints");
    pcl::visualization::PointCloudColorHandlerCustom<PointWithScale> tar_keypoints_color_handler(
        targetSiftKeypointsPtr, 0, 0, 255);
    viewer.addPointCloud<PointWithScale>(targetSiftKeypointsPtr, tar_keypoints_color_handler,
                                         "target keypoints", v1);
    viewer.setPointCloudRenderingProperties(pcl::visualization::PCL_VISUALIZER_POINT_SIZE, 7,
                                            "target keypoints");
    // Add transformed point cloud to viewer
    pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ> tf_cloud_color_handler(
        transformedCloudPtr, 0, 255, 0);
    viewer.addPointCloud<pcl::PointXYZ>(transformedCloudPtr, tf_cloud_color_handler,
                                        "initial aligned cloud", v2);
    pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ> target_cloud_color_handler(
        inputTrgCloudPtr, 0, 0, 255);
    viewer.addPointCloud<pcl::PointXYZ>(inputTrgCloudPtr, target_cloud_color_handler,
                                        "aligned cloudv2", v2);
...
void visualizeSinglePointCloudForBRISK(PointCloudPtr inputCloudPtr,
    ...
    // Visualization of keypoints along with the original cloud
    pcl::visualization::PCLVisualizer viewer("PCL Viewer");
    pcl::visualization::PointCloudColorHandlerCustom<PointWithScale> keypoints_color_handler(
        inputKeypointsCloudPtr, 0, 255, 0);
    pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ> cloud_color_handler(
        inputCloudPtr, 255, 255, 0);
...
void visualizeMatchingResults(PointCloudPtr inputCloudPtr, PointCloudPtr transformedCloudPtr) {
    ...
    viewer.addPointCloud<pcl::PointXYZ>(inputCloudPtr, tf_cloud_color_handler1,
                                        "initial aligned cloud1");
    pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ> tf_cloud_color_handler2(
        transformedCloudPtr, 0, 0, 255);
    viewer.addPointCloud<pcl::PointXYZ>(transformedCloudPtr, tf_cloud_color_handler2,
                                        "initial aligned cloud2");
...
void visualizeMultipleMatchingResults(PointCloudPtr inputTrgCloudPtr1,
    ...
    //  Add transformed point cloud to viewer
    pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ> src_cloud_color_handler(
        inputTrgCloudPtr1, 255, 255, 0);
    pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ> tar_cloud_color_handler(
        inputTrgCloudPtr2, 0, 255, 255);
    pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ> tf_cloud_color_handler1(
        transformedCloudPtr1, 0, 0, 255);
    pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ> tf_cloud_color_handler2(
        transformedCloudPtr2, 255, 0, 0);
    viewer.addPointCloud(inputTrgCloudPtr1, src_cloud_color_handler, "target cloud v1", v1);
    viewer.addPointCloud<pcl::PointXYZ>(transformedCloudPtr1, tf_cloud_color_handler1,
                                        "matching cloud1", v1);
    viewer.addPointCloud(inputTrgCloudPtr2, tar_cloud_color_handler, "target cloud v2", v2);
    viewer.addPointCloud<pcl::PointXYZ>(transformedCloudPtr2, tf_cloud_color_handler2,
                                        "matching cloud2", v2);
...
void visualizeResults(PointCloudPtr referenceCloudPtr, PointCloudPtr sourceCloudPtr,
    ...
    // Add transformed point cloud to viewer
    pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ> ref_cloud_color_handler1(
        referenceCloudPtr, 0, 255, 0);
    pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ> src_cloud_color_handler1(
        sourceCloudPtr, 255, 0, 0);
    pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ> tf_cloud_color_handler1(
        transformedCloudPtr, 0, 0, 255);
    pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ> cst_cloud_color_handler1(
        customTransformedCloudPtr, 135, 206, 235);
    ...
    viewer.addPointCloud(customTransformedCloudPtr, cst_cloud_color_handler1,
                         "custom transformed cloud v1");
    viewer.addPointCloud<pcl::PointXYZ>(transformedCloudPtr, tf_cloud_color_handler1,
                                        "matched cloud1");
...
void visualizeMultipleResults(PointCloudPtr referenceCloudPtr1, PointCloudPtr sourceCloudPtr1,
    ...
    // Add transformed point cloud to viewer
    pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ> ref_cloud_color_handler1(
        referenceCloudPtr1, 0, 255, 0);
    pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ> src_cloud_color_handler1(
        sourceCloudPtr1, 255, 0, 0);
    pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ> tf_cloud_color_handler1(
        transformedCloudPtr1, 0, 0, 255);
    pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ> cst_cloud_color_handler1(
        customTransformedCloudPtr1, 135, 206, 235);
    pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ> ref_cloud_color_handler2(
        referenceCloudPtr2, 0, 255, 0);
    pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ> src_cloud_color_handler2(
        sourceCloudPtr2, 255, 0, 0);
    pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ> tf_cloud_color_handler2(
        transformedCloudPtr2, 0, 0, 255);
    pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ> cst_cloud_color_handler2(
        customTransformedCloudPtr2, 135, 206, 235);
    ...
    viewer.addPointCloud(customTransformedCloudPtr1, cst_cloud_color_handler1,
                         "custom transformed cloud v1", v1);
    viewer.addPointCloud<pcl::PointXYZ>(transformedCloudPtr1, tf_cloud_color_handler1,
                                        "matched cloud1", v1);
    ...
    viewer.addPointCloud(customTransformedCloudPtr2, cst_cloud_color_handler2,
                         "custom transformed cloud v2", v2);
    viewer.addPointCloud<pcl::PointXYZ>(transformedCloudPtr2, tf_cloud_color_handler2,
                                        "matched cloud2", v2);
...
void visualizationToolSift(PointCloudPtr sourceCloudPtr, PointCloudPtr targetCloudPtr,
    ...
    if (pipelineSettings.getValue(VISUALIZER_PARAMETER) == 2.0f) {
        if (pipelineType == "sift") {
            std::cout << "\nDisplaying registration results of the point clouds & the sift "
                         "associated keypoints"
                      << std::endl;
            visualizeMultipleResultsPointCloudSift(sourceCloudPtr, targetCloudPtr,
                                                   srcSiftKeypointsCloudPtr,
                                                   trgSiftKeypointsCloudPtr, transformedCloudPtr);
        }
    }
}
...
void visualizationToolHarris(PointCloudPtr sourceCloudPtr, PointCloudPtr targetCloudPtr,
    ...
    if (pipelineSettings.getValue(VISUALIZER_PARAMETER) == 2.0f) {
        if (pipelineType == "harris") {
            std::cout << "\nDisplaying registration results of the point clouds & the harris "
                         "associated keypoints"
                      << std::endl;
            visualizeMultipleResultsPointCloudHarris(
                sourceCloudPtr, targetCloudPtr, srcHarrisKeypointsCloudPtr,
                trgHarrisKeypointsCloudPtr, transformedCloudPtr);
        }
    }
}
